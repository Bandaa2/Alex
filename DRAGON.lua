...
if res ~= 200 then
print('\27[0;31m⊱━━━━⊰𝑩𝑶𝑻 𝑨𝑳𝑬𝑿 ⊱━━━━⊰\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⊱━━━━⊰𝑩𝑶𝑻 𝑨𝑳𝑬𝑿 ⊱━━━━⊰\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⊱━━━━⊰𝑩𝑶𝑻 𝑨𝑳𝑬𝑿 ⊱━━━━⊰ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
var = true 
elseif tonumber(user_id) == tonumber(1741174283) then
var = true 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝑩𝑶𝑻 𝑨𝑳𝑬𝑿 ❁")  
...
usertext = '\n ❁ العضو » ['..result.title_..'](t.me/'..(username or 's_an_for1')..')'
status  = '\n ❁ تم ترقيته مطور'
...
usertext = '\n ❁ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_an_for1')..')'
status  = '\n ❁ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❁ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_an_for1')..') \n ❁ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❁ العضو : {["..data.first_name_.."](T.ME/s_an_for1)}\n ❁ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❁ عذرا » {["..data.first_name_.."](T.ME/s_an_for1)}\n ❁ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '👑 𝐃𝐄𝐕 𝐀𝐋𝐄𝐗 👑',url="t.me/G_2_2_G"}},
{{text = '🛡𝑩𝑶𝑻 𝑨𝑳𝑬𝑿 🛡',url="t.me/U550PBOT"}},
...
if text == 'مين نصبلك' or text == 'بوت اليكس' or text == 'بوت اليكس' then
local Text = [[
🕸اهلا بك في سورس بوت اليكس الجمدان  🕸
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑩𝑶𝑻 𝑨𝑳𝑬𝑿 ',url="t.me/U550PBOT"}},
...
if text == 'بوت اليكس' or text == 'bot'  then
local Text = [[
اقوي بوت حمايه  
]]
keyboard = {} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❁ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_an_for1')..') \n ❁ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❁ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 's_an_for1')..') \n ❁ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❁ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_an_for1')..')'
status  = '\n ❁ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❁ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❁ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_an_for1')..')'
...
' }\n'..' ❁  الايدي بالصوره » { '..idph..
' }\n'..' ❁  الرفع » { '..setadd..
' }\n'..' ❁  الحظر » { '..banm..' }\n\n⊱━━━━⊰𝑩𝑶𝑻 𝑨𝑳𝑬𝑿 ⊱━━━━⊰\n ❁ قناة سورس السنافر↓\n [ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝚂𝙽𝙰𝙵𝙴𝚁 ❁](t.me/s_an_for1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❁ العضو » ['..result.title_..'](t.me/'..(text1[3] or 's_an_for1')..')'..'\n ❁ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local DRAGON_Msg = {
'اسمي  '..Namebot..' يا يروحي 🌚❤️',
'اسمي '..Namebot..' يا قلبي🥺❤️',
'اسمي  '..Namebot..' يا كبدي 😂❤️',
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'اليكس')
send(msg.chat_id_, msg.id_,'انا ['..Namebot..'] يقمر❤️')
end
...
send(msg.chat_id_, msg.id_, t..'⊱━━━━⊰𝑩𝑶𝑻 𝑨𝑳𝑬𝑿 ⊱━━━━⊰ٴ\n❁ [ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝚂𝙽𝙰𝙵𝙴𝚁 ❁ ](t.me/s_an_for1)')
end
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝑩𝑶𝑻 𝑨𝑳𝑬𝑿  ', url="t.me/s_an_for1"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
