...
if res ~= 200 then
print('\27[0;31m⊱────⊰ ʙᴏᴛ ᴀʟᴇx 𖠛 ⊱────⊰\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⊱────⊰ ʙᴏᴛ ᴀʟᴇx 𖠛 ⊱────⊰\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⊱────⊰ ʙᴏᴛ ᴀʟᴇx 𖠛 ⊱────⊰ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Bandaa2/Alex/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1741174283,1366055467,1506445642}   
...
if tonumber(user_id) == tonumber(1741174283) then  
var = true 
elseif tonumber(user_id) == tonumber(1366055467) then
var = true 
elseif tonumber(user_id) == tonumber(1506445642) then
var = true  
...
local UserName = (data.username_ or "U440p")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼  ʙᴏᴛ ᴀʟᴇx 𖠛  ●")  
...
{'االاشتراك الاجباري✶','وضع قناة الاشتراك✶'},
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/Alex/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ● تم تحديث السورس \n ● لديك اخر اصدار لسورس السنافر \n ● الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ● اصدار سورس السنافر \n ● الاصدار »{ v 1.5}')
end
if text == 'اليكس ملك التلي' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[ⓀⓘⓝⒼ](t.me/G_2_2_G)
]] 
...
{{text = '𓆩 𝐀𝐋𝐄𝐗 𓆪', url="t.me/G_2_2_G"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘁𝘄𝗮𝘀𝗼𝗹', url="t.me/TAWALEXBOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text and text:match("^رفع قلب اليكس @(.*)$") and DevSoFi(msg) then
local username = text:match("^رفع قلب اليكس  @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n ● العضو » ['..result.title_..'](t.me/'..(username or 'U440p')..')'
status  = '\n ● تم ترقيته مطور'
...
usertext = '\n ● العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
status  = '\n ● تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ● العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'U440p')..') \n ● '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ● العضو : {["..data.first_name_.."](T.ME/U440p)}\n ● ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ● عذرا » {["..data.first_name_.."](T.ME/U440p)}\n ● عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '👑 ᴅᴇᴠ ᴀʟᴇx 👑',url="t.me/G_2_2_G"}},
{{text = '💞 ʙᴏᴛ  ᴀʟᴇx  💞',url="t.me/U550PBOT"}},
{{text = '💌 𝑩𝑶𝑻 𝑻𝑾𝑨𝑺𝑾𝑳 💌', url="t.me/TAWALEXBOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'بوت اليكس' or text == 'بوت' then
local Text = [[
💞 تفضل حبيبي انا اليكس 💞  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ʙᴏᴛ ᴀʟᴇx ',url="t.me/U550PBOT"}},
{{text = '𝑨𝑳𝑬𝑿 ',url="t.me/G_2_2_G"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𓆩 𝑨𝑳𝑬𝑿 𓆪 ',url="t.me/G_2_2_G"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب بوت اليكس' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ● بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'U440p')..') \n ● تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ● بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'U440p')..') \n ● تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1741174283) then  
...
if tonumber(result.sender_user_id_) == tonumber(1506445642) then  
send(msg.chat_id_, msg.id_, " ● لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1741174283) then
...
if result.id_ == tonumber(1506445642) then
send(msg.chat_id_, msg.id_, " ● لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1741174283) then  
send(msg.chat_id_, msg.id_, " ● لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1506445642) then  
send(msg.chat_id_, msg.id_, " ● لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/Alex/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ● اهلا بك في متجر ملفات السنافر \n ● ملفات السورس ↓\n⊱────⊰ ʙᴏᴛ ᴀʟᴇx 𖠛 ⊱────⊰\n\n"
local TextE = "\n⊱────⊰ ʙᴏᴛ ᴀʟᴇx 𖠛 ⊱────⊰\n ● علامة تعني { ✔️ } ملف مفعل\n ● علامة تعني { ✖ } ملف معطل\n ● قناة سورس السنافر↓\n".." ● [اضغط هنا لدخول](t.me/U440p) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/Alex/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ● عذرا الملف لايدعم سورس السنافر\n") 
end
return false
end
...
if text == ("رفع قلب اليكس") and msg.reply_to_message_id_ and DevSoFi(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ● لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
status  = '\n ● تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ● العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ● العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ● العضو » ['..result.title_..'](t.me/'..(text1[3] or 'U440p')..')'..'\n ● تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."U440p:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."U440p:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."U440p:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."U440p:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"●تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."U440p:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."U440p:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس اليكس يعني لو بك اعرفك انت الاخذتهن
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
local iduser = result.sender_user_id_
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ● هو الدزمه ده الي ضافك😹❤️» '..Name
...
if Num == 0 then 
Text = ' ● ضيف ياعم ربنا يكرمك 😿'
else
Text = ' ● كمل وحيات امك جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevSoFi(msg) then 
...
{
{text = ' ʙᴏᴛ ᴀʟᴇx 𖠛 ', url="t.me/U550PBOT"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '  ʙᴏᴛ ᴀʟᴇx 𖠛  ', url="t.me/U550PBOT"},
{text = 'مبرمج السورس', url="t.me/G_2_2_G"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'⊱────⊰ ʙᴏᴛ ᴀʟᴇx 𖠛 ⊱────⊰ٴ\n● [ ʙᴏᴛ ᴀʟᴇx 𖠛  ● ](t.me/U550PBOT)')
end
